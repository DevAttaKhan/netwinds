...
import { Sparkles, Palette, Code2, Smartphone, Zap, Target } from "lucide-react";
        ...
        <div className="text-center max-w-4xl mx-auto relative">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="text-accent">of Possibilities</span>
            </motion.h1>
            ...
            >
              While we&apos;re building our client portfolio, explore our capabilities, 
              design concepts, and technical expertise that showcase what we can create for you.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-2 px-3 py-2 bg-white/10 backdrop-blur-sm rounded-full">
                ...
                <span className="text-white/90 text-xs sm:text-sm">Design Concepts</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-2 bg-white/10 backdrop-blur-sm rounded-full">
                <Code2 className="w-4 h-4 text-accent" />
                <span className="text-white/90 text-xs sm:text-sm">Technical Skills</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-2 bg-white/10 backdrop-blur-sm rounded-full">
                <Smartphone className="w-4 h-4 text-accent" />
                <span className="text-white/90 text-xs sm:text-sm">Mobile Solutions</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-2 bg-white/10 backdrop-blur-sm rounded-full">
                <Zap className="w-4 h-4 text-accent" />
                <span className="text-white/90 text-xs sm:text-sm">Performance</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 bg-accent rounded-full"></div>
                <span className="text-xs">Performance Focus</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
