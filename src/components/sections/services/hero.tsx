...
import { ArrowRight, Code2, Palette, Smartphone, Zap, Sparkles } from "lucide-react";
        ...
        <div className="text-center max-w-4xl mx-auto relative">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="text-accent">That Drive</span>
              <br />
            ...
            >
              From concept to deployment, we deliver cutting-edge web solutions that 
              transform your business and exceed your expectations.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-2 px-3 py-2 bg-white/10 backdrop-blur-sm rounded-full">
                ...
                <span className="text-white/90 text-xs sm:text-sm">Development</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-2 bg-white/10 backdrop-blur-sm rounded-full">
                <Palette className="w-4 h-4 text-accent" />
                <span className="text-white/90 text-xs sm:text-sm">Design</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-2 bg-white/10 backdrop-blur-sm rounded-full">
